...
vim.keymap.set('n', '<Leader>dom', '<CMD>DiffviewOpen ' .. default_branch .. '...HEAD<CR>', { desc = 'Show Diffview UI Relative to Main' })
vim.keymap.set('n', '<Leader>dh', '<CMD>DiffviewFileHistory<CR>', { desc = 'Show Diffview File History UI' })
vim.keymap.set('n', '<Leader>df', '<CMD>DiffviewFileHistory %<CR>', { desc = 'Show Diffview File History UI on current file' })
vim.keymap.set(
  'n',
  '<Leader>dhm',
